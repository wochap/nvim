...
local M = {
  ...
  ["@boolean.nix"] = { link = "BooleanNix" },
  ["@constant.builtin"] = { link = "ConstantBuiltin" },
  ["@constant.builtin.javascript"] = { link = "ConstantBuiltinJavascript" },
  ["@constant.builtin.python"] = { link = "ConstantBuiltinPython" },
  ["@constant.javascript"] = { link = "Variable" },
  ["@constructor"] = { link = "Constructor" },
  ["@constructor.javascript"] = { link = "ConstructorJavascript" },
  ["@field"] = { link = "Field" },
  ["@field.nix"] = { link = "FieldNix" },
  ["@function.builtin"] = { link = "FunctionBuiltin" },
  ["@function.builtin.python"] = { link = "FunctionBuiltinPython" },
  ["@function.call"] = { link = "FunctionCall" },
  ["@function.call.javascript"] = { link = "FunctionCallJavascript" },
  ["@keyword"] = { link = "Keyword" },
  ["@keyword.operator"] = { link = "KeywordOperator" },
  ["@keyword.operator.python"] = { link = "KeywordOperatorPython" },
  ["@lsp.type.variable.lua"] = { link = "Variable" },
  ["@nospell.markdown_inline"] = { link = "NoSpellMarkdownInline" },
  ["@operator"] = { link = "Operator" },
  ["@parameter"] = { link = "Parameter" },
  ["@parameter.javascript"] = { link = "ParameterJavascript" },
  ["@parameter.nix"] = { link = "ParameterNix" },
  ...
  ["@punctuation.special.markdown"] = { link = "PunctuationSpecialMarkdown" },
  ["@spell.markdown"] = { link = "SpellMarkdown" },
  ["@string"] = { link = "String" },
  ["@string.escape"] = { link = "StringEscape" },
  ["@tag.attribute"] = { link = "TagAttribute" },
  ["@tag.delimiter"] = { link = "TagDelimiter" },
  ["@text.literal.markdown_inline"] = { link = "TextLiteralMarkdownInline" },
