...
local M = {
  ...
  -- Pmenu = {
  --   bg = utils.darken(C.surface0, 0.8, C.crust),
  --   fg = C.overlay2,
  ...
  QuickFixLine = { bg = C.surface1 }, -- Current |quickfix| item in the quickfix window. Combined with |hl-CursorLine| when the cursor is there.
  ...
  Visual = { bg = C.surface1 }, -- Visual mode selection
  VisualNOS = { bg = C.surface1 }, -- Visual mode selection when vim is "Not Owning the Selection".
